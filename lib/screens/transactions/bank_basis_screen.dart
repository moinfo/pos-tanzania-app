          ...
          ElevatedButton(
            onPressed: () async {
              ...
              final result =
                ...
                action: OfflineAction.bankBasisCategory,
                payload: ApiService.namedCategoryBody(
                    name: name, description: description),
                summary: name,
                send: (requestId) => _apiService.addBankBasisCategory(
                  name: name,
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                final result =
                    await _offlineSubmit.submit<Map<String, dynamic>>(
                  context: this.context,
                  action: OfflineAction.bankBasis,
                  payload: ApiService.bankBasisBody(
                      bankBasisId: categoryId, amount: amount, date: date),
                  summary: '$date - $amount',
                  send: (requestId) => _apiService.addBankBasisTransaction(
                    bankBasisId: categoryId,
                    amount: amount,
                    date: date,
                    requestId: requestId,
                  ),
