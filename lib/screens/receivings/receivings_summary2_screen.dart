...
class ReceivingsSummary2Screen extends StatefulWidget {
  const ReceivingsSummary2Screen({super.key});

  @override
  State<ReceivingsSummary2Screen> createState() => _ReceivingsSummary2ScreenState();
}

class _ReceivingsSummary2ScreenState extends State<ReceivingsSummary2Screen> {
  ...
  Future<void> _loadSummary() async {
    ...
    try {
      final response = await _apiService.getReceivingSummary2(
  ...
  /// Data table with Leruma data first (primary), then Mainstore (comparison)
  /// Column order: Item Name → Leruma Qty → Leruma Receiving → Mainstore Qty → Mainstore Price → Diff Qty → Diff Price
